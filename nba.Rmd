...
Let $Y_{i}$  denote the number of wins for a single team in a single season where i = 1, ..., 210 We assume that $Y_{i}: i=1,...,210$ is a set of independent Poisson random variables. We will model the mean number of wins, $\mu_{i}$, by team $i$ per season (82 games) $P_{i}$. 

<p align="center">
  <img width="400" height="400" src="/graphics/equation1.png">
</p>

<p align="center">
  <img width="400" height="400" src="/graphics/equation2.png">
</p>

$x_i = x_{i1},..., x_{i6}$ are the 6 covariates for observation $i$, where each covariate pertains to the following variables, respectively: "three-point attempts", "two-point attempts", "offensive rebounds", "defensive rebounds", "assists", "steals", and "turnovers".  
