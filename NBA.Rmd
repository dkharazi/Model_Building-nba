...
Let Yi denote the number of wins for a single team in a single season where i = 1, ..., 210 We assume that Yi: i=1,...,210$ is a set of independent Poisson random variables. We will model the mean number of wins, \mu_i, by team i per season (82 games) Pi. 
